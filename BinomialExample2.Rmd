...
To determine the MLE we try many possibility for p.  I include the code in case you are an R geek (BIS180L Students this means you), otherwise you can ignore the code and just check out the plot:
